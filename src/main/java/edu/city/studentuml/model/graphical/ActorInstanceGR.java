...
public class ActorInstanceGR extends AbstractSDObjectGR {
    ...
    public boolean edit(EditContext context) {
        ...
        ActorInstance originalActorInstance = getActorInstance();

        // Create editor and initial result
        ActorInstanceEditor actorInstanceEditor = createEditor(context);
        TypedEntityEditResult<Actor, ActorInstance> initialResult = new TypedEntityEditResult<>(
                originalActorInstance, new java.util.ArrayList<>());
        ...
        if (!originalActorInstance.getName().equals(newActorInstance.getName())
            ...
            ActorInstanceEdit originalEdit = new ActorInstanceEdit(originalActorInstance,
                    originalActorInstance.getActor().getName());
            compoundEdit.addEdit(new EditActorInstanceEdit(originalEdit, undoEdit, context.getModel()));
        }
    ...
    /**
     * Creates the editor for this Actor Instance. Extracted into a protected method
